...
export function FeaturesTab() {
    ...
    const handleOpenModal = (feature?: Feature) => {
        if (feature) {
            ...
            setPriceMonthly((feature.price_monthly || 0).toString())
            setPriceYearly((feature.price_yearly || 0).toString())
            setCategory(feature.category || "Standart")
        } else {
    ...
    const handleSave = async () => {
        ...
        try {
            const featureData = {
                ...
                category: category.trim() || 'Standart'
            }
    ...
    return (
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-col gap-1 mb-3">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        <div className="flex items-center gap-1.5 text-[11px] font-bold text-primary bg-primary/10 w-fit px-1.5 py-0.5 rounded border border-primary/20">
                                            {feature.category || 'Standart'}
                                        </div>
                                        {feature.price_monthly > 0 && (
                                            <div className="flex items-center gap-1 text-[11px] font-bold text-success bg-success/10 w-fit px-1.5 py-0.5 rounded border border-success/20">
                                                ₺{feature.price_monthly} / Ay
                                            </div>
                                        )}
                                    </div>
                                </div>
            ...
            <RxModal
                ...
                title={editingFeature ? "Özellik Düzenle" : "Yeni Özellik Tanımla"}
            >
                <div>
                   <p className="text-sm font-medium text-gray-500 mb-6">Sistem özelliklerini (key) tanımlarken teknik isimlendirme standartlarına (örn: ai_assistant) uymanız önerilir.</p>
                </div>
