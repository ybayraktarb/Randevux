...
import { getProductsAction, upsertProductAction, adjustStockAction, getInventoryLogsAction } from "@/src/modules/inventory/actions/inventory.actions"
...
function StockAdjustModal({ product, businessId, onClose, onSuccess }: { product: any, businessId: string, onClose: () => void, onSuccess: () => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (res.success) {
            ...
            toast.error(res.error || "Stok güncellenemedi")
        }
    }
