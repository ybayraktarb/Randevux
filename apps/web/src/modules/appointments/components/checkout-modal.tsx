    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-xl rounded-premium bg-white shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-white/20"
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-8 py-8 space-y-8 custom-scrollbar">
            <div className="p-6 rounded-card bg-indigo-600 text-white relative overflow-hidden group">
