...
import { BillingSettings } from "@/src/modules/business/components/billing-settings"
...
export function BusinessSettings() {
    ...
    const [activeTab, setActiveTab] = useState<"business" | "appointment" | "profile" | "hours" | "closed" | "announcements" | "billing">("business")
    ...
    const tabs = [
        ...
        { key: "billing" as const, label: "Abonelik & Fatura", icon: CreditCard },
        ...
        { key: "appointment" as const, label: "Randevu", icon: Calendar },
            ...
            <div className="relative mt-2">
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {activeTab === "billing" && businessData && (
                            <BillingSettings businessId={businessData.id} />
                        )}
